...
function ImportURLUI({ failed_model_id, mutationToUse }: { failed_model_id: string, mutationToUse: UseMutationResult<undefined, Error, { id_to_resolve: string; url: string; type: string; }, unknown> }) {
    const [modelURLToImport, setModelURLToImport] = useState("");
    const [modelTypeToImport, setModelTypeToImport] = useState<"hf" | "civit" | "custom">("hf");
    ...
    return (
        ...
        <div className='flex flex-row items-center space-x-4'>
            ...
            onValueChange={(currentValue) => {
                if (currentValue === "hf" || currentValue === "civit" || currentValue === "custom") {
                ...
                <div className="flex items-center space-x-2">
                    <RadioGroupItem className='text-white border-white' value="custom" id="r3" />
                    <Label className='text-white' htmlFor="r3">Custom</Label>
                </div>
            </RadioGroup>
        </div>
        <div className='w-full flex flex-row space-x-2 items-center'>
            ...
            onClick={(e) => {
                ...
                mutationToUse.mutate({ id_to_resolve: failed_model_id, url: modelURLToImport, type: modelTypeToImport })
            }}
            >
